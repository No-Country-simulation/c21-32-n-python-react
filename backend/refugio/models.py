...
class Refugio(models.Model):
    ...
    dirlogo = models.ImageField(max_length=100,null=True)    
    ...
    mision = models.CharField(max_length=100,null=True, blank=False)
    vision = models.CharField(max_length=100,null=True, blank=False)
