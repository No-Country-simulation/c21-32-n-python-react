...
const CardDetail = ({ imageSrc, date, title, description, edad,peso,raza,sexo }) => {
    return (
        <div className="flex justify-around pt-12 ">
            <div className="relative w-1/3 h-64 ">
                <Image className="rounded-lg m-auto"
                    src={imageSrc}
                    alt={title}                    
                    objectFit="cover"
                    width={300}
            ...
            <div className="p-4 w-2/3 bg-white rounded-lg ">
                ...
                <h2 className="text-xl font-semibold mb-2"><span>Nombre:</span> {title}</h2>
                <p className="text-gray font-semibold mb-2"><span>Descripción</span></p>
                <p className="text-gray-700 pb-10">
                    ...
                    <br />
                    <span className="text-gray font-semibold">Sexo:</span> {sexo}
                </p>                
                <Link href="#">
