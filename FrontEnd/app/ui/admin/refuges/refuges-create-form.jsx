...
>
  ...
  <div className="flex flex-col w-[30%]">
    <label htmlFor="dirlogo" className="text-gray-700 font-medium">Logo:</label>
    <input
      type="file"
  ...
  <button
    type="submit"
    className="bg-blue-500 w-1/5 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
  >
    Enviar
  </button>
</div>
