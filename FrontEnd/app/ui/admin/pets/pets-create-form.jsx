...
function PetsCreateForm({ refuges }) {
  ...
  return (
    <div className="h-auto w-auto mt-10 mr-2 ml-2 p-2 bg-[#024873] border rounded-3xl">
      ...
      >
        <div className="pb-6">
          <p className="flex justify-center items-center font-bold text-5xl mb-7 text-[#0e4a67]">
            Registro Mascota
          </p>
          <label
            htmlFor="nombre"
        ...
        <div className="pb-6">
          <label htmlFor="raza" className="block font-medium text-gray-700">
            Raza:
          </label>
          <input
            id="raza"
        ...
        <div className="pb-6">
          <label htmlFor="edad" className="block font-medium text-gray-700">
            Edad:
          </label>
          <input
            id="edad"
        ...
        <div className="pb-6">
          <label htmlFor="sexo" className="block font-medium text-gray-700">
            Sexo:
          </label>
          <select
            name="sexo"
